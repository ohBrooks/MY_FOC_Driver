...
(library Library_1
	...
	(compDef "INA240A2PW" (originalName "INA240A2PW") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "REF2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VS") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/ina240")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "INA240A2PW.stp")
